export const rootColors: {
  shadowBox: string,
  lightPartsColor: string,
  darkFont: string,
  gradientColor1: string,
  gradientColor2: string,
  smallWraperGradient1: string,
  smallWraperGradient2: string,
  buttonColor: string,
  buttonHoverColor: string,
  buttonShadowBox: string,
  buttonTextColor: string,
  errorMsg: string,
  deleteBtnColor: string,
  deleteBtnHoverColor: string,
  tableHeaderBackground: string,
  tableBorderColor: string,
  filterLabelColor: string,
  filterPlaceholderColor: string,
